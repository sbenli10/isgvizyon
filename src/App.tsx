...
const OrientationTraining = lazyWithRetry("orientation-training", () => import("./pages/OrientationTraining"));
const EmergencyDrillReport = lazyWithRetry("emergency-drill-report", () => import("./pages/EmergencyDrillReport"));
const SuggestionLedger = lazyWithRetry("suggestion-ledger", () => import("./pages/SuggestionLedger"));
const DisciplinaryNotice = lazyWithRetry("disciplinary-notice", () => import("./pages/DisciplinaryNotice"));
      ...
      <AppLayout>
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/isbasi-oryantasyon-egitim-tutanagi" element={<OrientationTraining />} />
            <Route path="/acil-durum-tatbikat-tutanagi" element={<EmergencyDrillReport />} />
            <Route path="/tespit-oneri-defteri" element={<SuggestionLedger />} />
            <Route path="/ceza-teblig-tutanagi" element={<DisciplinaryNotice />} />
            ...
            <Route path="/osgb/personnel" element={<FeatureAccessGate featureKey="osgb.access" title="OSGB personel ekranı OSGB paketinde açılır" description="OSGB personel planlama, uzman dağılımı ve ekip takibi yalnızca OSGB paketine dahildir."><OsgbAccessGate><OSGBPersonnel /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/assignments" element={<FeatureAccessGate featureKey="osgb.access" title="OSGB görevlendirme ekranı OSGB paketinde açılır" description="OSGB görevlendirme, uzman atama ve takip akışları yalnızca OSGB üyelikte kullanılabilir."><OsgbAccessGate><OSGBAssignments /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/company-tracking" element={<FeatureAccessGate featureKey="osgb.access" title="OSGB firma takibi OSGB paketinde açılır" description="Çoklu firma takibi, sözleşme ve portföy yönetimi yalnızca OSGB modülüne dahildir."><OsgbAccessGate><OSGBCompanyTracking /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/capacity" element={<FeatureAccessGate featureKey="osgb.access" title="OSGB kapasite ekranı OSGB paketinde açılır" description="Uzman kapasitesi, doluluk ve atama baskısı görünümü yalnızca OSGB modülünde yer alır."><OsgbAccessGate><OSGBCapacity /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/field-visits" element={<FeatureAccessGate featureKey="osgb.access" title="OSGB saha hizmet ekranı OSGB paketinde açılır" description="Saha ziyaretleri, hizmet ispatı ve kanıt takibi yalnızca OSGB modülüne dahildir."><OsgbAccessGate><OSGBFieldVisits /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/alerts" element={<FeatureAccessGate featureKey="osgb.access" title="OSGB uyarı merkezi OSGB paketinde açılır" description="Portföy bazlı OSGB uyarıları ve takip akışları yalnızca OSGB üyelikte açılır."><OsgbAccessGate><OSGBAlerts /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/finance" element={<FeatureAccessGate featureKey="osgb.access" title="OSGB finans ekranı OSGB paketinde açılır" description="Cari, tahsilat ve kârlılık görünümü yalnızca OSGB modülünün parçasıdır."><OsgbAccessGate><OSGBFinance /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/documents" element={<FeatureAccessGate featureKey="osgb.access" title="OSGB belge ekranı OSGB paketinde açılır" description="Yasal yükümlülükten türeyen evrak takibi ve hızlı aksiyonlar yalnızca OSGB modülüne dahildir."><OsgbAccessGate><OSGBDocuments /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/isgkatip" element={<FeatureAccessGate featureKey="osgb.access" title="İSG-KATİP merkezi OSGB paketinde açılır" description="Senkronizasyon, uyum bayrakları ve kaynak firma görünümü yalnızca OSGB modülüne dahildir."><OsgbAccessGate><OsgbKatipSyncCenter /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/automation" element={<FeatureAccessGate featureKey="osgb.access" title="OSGB otomasyon merkezi OSGB paketinde açılır" description="Görev, bildirim ve operasyon otomasyonları yalnızca OSGB modülünde yer alır."><OsgbAccessGate><OsgbAutomationCenter /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/client-portal" element={<FeatureAccessGate featureKey="osgb.access" title="Müşteri portalı OSGB paketinde açılır" description="Firma ile paylaşılan portal linkleri ve dış görünüm yalnızca OSGB modülüne dahildir."><OsgbAccessGate><OsgbClientPortal /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/how-to" element={<OsgbHowTo />} />
            <Route path="/osgb/tasks" element={<FeatureAccessGate featureKey="osgb.access" title="OSGB görev takibi OSGB paketinde açılır" description="OSGB görev takibi, iş dağılımı ve ekip operasyonları yalnızca OSGB paketine dahildir."><OsgbAccessGate><OSGBTasks /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/notes" element={<FeatureAccessGate featureKey="osgb.access" title="OSGB notları OSGB paketinde açılır" description="OSGB not akışları ve operasyon içi koordinasyon ekranı yalnızca OSGB üyelikle kullanılabilir."><OsgbAccessGate><OSGBNotes /></OsgbAccessGate></FeatureAccessGate>} />
            <Route path="/osgb/analytics" element={<FeatureAccessGate featureKey="osgb.access" title="OSGB analitik ekranı OSGB paketinde açılır" description="OSGB performans, kapasite ve portföy analitikleri yalnızca OSGB modülüne dahildir."><OsgbAccessGate><OSGBAnalytics /></OsgbAccessGate></FeatureAccessGate>} />
