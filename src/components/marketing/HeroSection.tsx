        ...
        <div className="relative grid min-h-[440px] bg-white md:grid-cols-[235px_minmax(0,1fr)]">
          ...
          <div className="p-4 sm:p-6">
            ...
            <div className="mt-5 grid gap-4 lg:grid-cols-[minmax(0,1fr)_290px]">
              ...
              <div className="overflow-hidden rounded-2xl border border-cyan-100 bg-gradient-to-b from-cyan-50 via-white to-blue-50 p-4 shadow-sm">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="rounded-full bg-white text-blue-700 shadow-sm hover:bg-white">
                    Akıllı analiz
                  </Badge>
                </div>
