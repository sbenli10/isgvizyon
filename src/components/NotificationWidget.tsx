    ...
    <div className="rounded-[24px] p-5">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="rounded-2xl border border-cyan-400/20 bg-cyan-400/10 p-3 text-cyan-600 dark:text-cyan-200">
        ...
        <div className="flex items-center gap-2">
          ...
          {unreadCount > 0 && (
            <Badge className="border-red-500/20 bg-red-500/15 text-red-700 dark:text-red-100">
              {unreadCount} yeni
            </Badge>
          )}
        </div>
      ...
      <div className="mt-5 space-y-3">
        {criticalNotifications.length === 0 ? (
          <div className="rounded-2xl border border-border bg-muted/50 py-8 text-center text-sm text-muted-foreground">
          ...
          <>
            {criticalNotifications.map((notification, index) => (
              <div
                key={notification.id}
                className="group relative overflow-hidden rounded-2xl border border-border bg-muted/30 p-4 transition-all hover:border-cyan-400/20 hover:bg-muted/60 cursor-pointer"
              ...
              >
                ...
                <div className="flex items-start gap-3 pl-3">
                  <div className="mt-0.5 rounded-full border border-border bg-background p-1.5">
                    <span
