    ...
    <div className="rounded-[24px] p-5">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          <div className="rounded-2xl border border-cyan-200 bg-cyan-50 p-3 text-cyan-700 dark:border-cyan-400/20 dark:bg-cyan-400/10 dark:text-cyan-200">
            <Radar className="h-5 w-5" />
          </div>
          <div>
            <p className="text-[11px] uppercase tracking-[0.22em] text-muted-foreground">Control Feed</p>
            <p className="mt-1 text-lg font-semibold text-foreground">Acil Bildirimler</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          {unreadCount > 0 && (
            <Badge className="border-red-200 bg-red-50 text-red-700 dark:border-red-500/20 dark:bg-red-500/15 dark:text-red-100">
              {unreadCount} yeni
            </Badge>
          )}
        </div>
      ...
      <div className="mt-5 space-y-3">
        {criticalNotifications.length === 0 ? (
          <div className="rounded-2xl border border-border bg-muted/30 py-8 text-center text-sm text-muted-foreground">
          ...
          <>
            {criticalNotifications.map((notification, index) => (
              <div
                key={notification.id}
                className="group relative overflow-hidden rounded-2xl border border-border bg-card/50 p-4 transition-all hover:border-cyan-300 hover:bg-card cursor-pointer dark:border-border/60 dark:bg-card/30 dark:hover:border-cyan-400/20"
              ...
              >
                ...
                <div className="flex items-start gap-3 pl-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-2 line-clamp-1 text-sm font-semibold text-foreground">{notification.title}</p>
