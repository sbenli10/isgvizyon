...
import { OsgbDocumentProfileDialog } from "@/components/osgb/OsgbDocumentProfileDialog";
import {
...
export function OSGBCompaniesPanel({ refreshKey }: { refreshKey: number }) {
  ...
  const [documentProfileCompany, setDocumentProfileCompany] = useState<OsgbManagedCompanyRecord | null>(null);
