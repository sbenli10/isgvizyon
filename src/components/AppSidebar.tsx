      ...
      return [
        ...
        },
        {
          ...
          items: [
            ...
            { title: "İşbaşı Eğitim Tutanağı", url: "/isbasi-oryantasyon-egitim-tutanagi", icon: Users, iconClassName: "text-emerald-400 group-hover:text-emerald-300", badge: null },
            { title: "Tatbikat Tutanağı", url: "/acil-durum-tatbikat-tutanagi", icon: Flame, iconClassName: "text-orange-400 group-hover:text-orange-300", badge: null },
            { title: "Tespit ve Öneri Defteri", url: "/tespit-oneri-defteri", icon: ClipboardCheck, iconClassName: "text-amber-400 group-hover:text-amber-300", badge: null },
            {
