...
create index if not exists idx_osgb_finance_records_organization_id_v2
  on public.osgb_finance_records(organization_id);

create index if not exists idx_osgb_finance_records_company_id_v2
  on public.osgb_finance_records(company_id);

create index if not exists idx_osgb_finance_records_period_v2
...
create index if not exists idx_osgb_finance_records_status_v2
  on public.osgb_finance_records(organization_id, status);

create unique index if not exists idx_osgb_finance_records_unique_company_period_v2
